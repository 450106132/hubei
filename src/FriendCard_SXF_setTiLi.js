...
var FriendCard_SXF_setTiLi = cc.Layer.extend({
    ...
    readRoomConfig: function(back){
        ...
        // back.getChildByName("img_bg2_1").getChildByName("CheckBox_sywj").setSelected(this.setTiLiData.shareCostWhenManyWinner == 2)
        ...
        back.getChildByName("img_bg2_1").getChildByName("Text_baifenhao_1").setVisible(this.setTiLiData.isFixRate == 0)
        back.getChildByName("img_bg2_1").getChildByName("Text_baifenhao_2").setVisible(this.setTiLiData.isFixRate == 0)
        back.getChildByName("img_bg2_1").getChildByName("Text_baifenhao_3").setVisible(this.setTiLiData.isFixRate == 0)
        ...
        back.getChildByName("img_bg2_2").getChildByName("Text_baifenhao_1").setVisible(this.setTiLiData.isMinGuaranteeFixRate == 0)
        back.getChildByName("img_bg2_2").getChildByName("Text_baifenhao_2").setVisible(this.setTiLiData.isMinGuaranteeFixRate == 0)
        back.getChildByName("img_bg2_2").getChildByName("Text_baifenhao_3").setVisible(this.setTiLiData.isMinGuaranteeFixRate == 0)
