...
var HomeView_hbqp_v3 = cc.Layer.extend({
    ...
    initBottomPanel: function() {
        ...
        btnMore.setPosition(cc.p(710, 2700));//wj
        ...
        // }, this);
        bottom_bg.getChildByName("moreLayer").setVisible(true);
    ...
    initBtnKeFu: function(parent) {
        ...
        //wj 客服位置
        this.kefuPos = _BtnKeFu.getPosition();
        //wj 客服隐藏
    ...
    initBtnHTP: function(parent) {
        ...
        _BtnHTP.setPosition(cc.p(0,290));
    ...
    initZhanjiBtn: function(parent) {
        ...
        //wj
        _zhanji.visible = false;
    },

    // 邮件
    initYoujianBtn: function(parent) {
        parent = this.uiNode.getChildByName("bottom_bg");//wj
        this._youjian = parent.getChildByName("youjian");
        this._youjian.visible = true;
        // this._youjian.setPosition(cc.p(-150,290));//wj
        this._youjian.setPosition(this.kefuPos);
    ...
    initInviteShenheBtn: function(parent){
        if (isAgent()) {//代理才有的按钮
            ...
            // parent.addChild(this._inviteShenheBtn);//wj
            this.uiNode.getChildByName("bottom_bg").addChild(this._inviteShenheBtn);
            // this._inviteShenheBtn.setPosition(cc.p(150, 290));//wj
            this._inviteShenheBtn.setPosition(cc.p(401, 41));//wj
    ...
    initJoinRoomBtn: function(parent) {
        this._joinRoom = this.uiNode.getChildByName("gamePanel").getChildByName("joinRoom");
        // this._joinRoom.setPosition(cc.p(1465,225));
        // this._joinRoom.setScale = 1.2;
        // this._joinRoom.width = 218;
        // this._joinRoom.height = 171;
    ...
    initCreateRoomBtn: function(parent) {
        this._createRoom = this.uiNode.getChildByName("gamePanel").getChildByName("createRoom");//wj
        // this._createRoom.setPosition(cc.p(1125,225));
        // this._createRoom.setScale = 1.2;
        // this._createRoom.width = 218;
        // this._createRoom.height = 171;
    ...
    initGamePanel: function() {
        ...
        gamePanelNode.width = 448 * 1.2;
        gamePanelNode.height = 211 * 1.2;
        gamePanelNode.setAnchorPoint(0.5, 0.5);
        setWgtLayout(gamePanelNode, [gamePanelNode.width / 1560, gamePanelNode.height / 720], [0.875, 0.5], [0, 0]);
        this._gamePanelNode = gamePanelNode;

        //金币场
        var goldBtn = gamePanelNode.getChildByName("goldBtn");
        goldBtn.setVisible(false);//屏蔽金幣場
        ...
        // clubEnter.setPosition(cc.p(-13,235));
        clubEnter.setScale = 1.2;
        clubEnter.width = 448;
        clubEnter.height = 211;
    ...
    initThirdPartyGamePanel: function() {
        ...
        var thirdPartyGamePanel = this.uiNode.getChildByName("thirdPartyGamePanel");
        thirdPartyGamePanel.visible = false;
