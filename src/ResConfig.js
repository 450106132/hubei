...
function initResourceDir() {
    ...
    if (cc.sys.OS_WINDOWS == cc.sys.os) {
        var appDirs = {};
    	appDirs[MjClient.APP_TYPE.QXJSMJ] = "lyg";
		appDirs[MjClient.APP_TYPE.QXHAIANMJ] = "haian";
		appDirs[MjClient.APP_TYPE.QXHAMJ] = "huaian";
		appDirs[MjClient.APP_TYPE.QXXZMJ] = "xuzhou";
		appDirs[MjClient.APP_TYPE.QXYYQP] = "yueyang";
		appDirs[MjClient.APP_TYPE.TXJINZHONGMJ] = "jinzhong";
		appDirs[MjClient.APP_TYPE.QXNTQP] = "nantong";
        appDirs[MjClient.APP_TYPE.YLHUNANMJ] = "ylhunan";
    	appDirs[MjClient.APP_TYPE.QXYZQP] = "yongzhou";
		appDirs[MjClient.APP_TYPE.QXLYQP] = "leiyang";
		appDirs[MjClient.APP_TYPE.BDHYZP] = "hengyang";
		appDirs[MjClient.APP_TYPE.QXSYDTZ] = "shaoyang";
		appDirs[MjClient.APP_TYPE.QXXXGHZ] = "xiangxiang";
        appDirs[MjClient.APP_TYPE.AYGUIZHOUMJ] = "guizhou";
        appDirs[MjClient.APP_TYPE.LYSICHUANMJ] = "sichuan";
        appDirs[MjClient.APP_TYPE.HUNANWANGWANG] = "hunanwangwang";
        appDirs[MjClient.APP_TYPE.DQSHANXIMJ] = "shanxi";
